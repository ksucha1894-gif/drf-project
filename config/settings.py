...
DATABASES = {
    "default": {
        ...
        # Если переменная DATABASE_HOST передана (например, в CI/CD это localhost, а на сервере в .env это db),
        # Django возьмёт её. Если переменной нет — автоматически подставится безопасный локальный 'localhost'!
